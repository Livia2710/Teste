...
export default function Search() {
  return (
    <div>
      <h3 className='text-2xl text-white font-bold tracking-tight mb-4'>Explore alguns gêneros</h3>
      ...
      <div>
      <h3 className='text-2xl text-white font-bold tracking-tight mb-4'>Você também pode gostar</h3>
